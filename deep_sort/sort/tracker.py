...
class Tracker:
    ...
    def __init__(self, models_name, metric, metric_l, max_iou_distance=0.7, max_age=70, n_init=3):
    ...
    def _initiate_track(self, detection):
        ...
        self.tracks.append(Track(
            ...
            detection.feature, detection.feature_l))
        self._next_id += 1
